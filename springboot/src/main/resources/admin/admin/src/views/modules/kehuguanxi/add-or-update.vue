    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="合作内容" prop="hezuoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="合作内容"
                  v-model="ruleForm.hezuoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.hezuoneirong" label="合作内容" prop="hezuoneirong">
                    <span>{{ruleForm.hezuoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='hezuoneirong'){
            this.ruleForm.hezuoneirong = obj[o];
	    this.ro.hezuoneirong = true;
            continue;
          }
          if(o=='yonghuming'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kehuguanxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kehuguanxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
